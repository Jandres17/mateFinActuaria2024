...
A.2=5
# Creamos un vector númerico llamado vector1:
vector1=c(1,2,pi,10)
# Creamos un vector con secuencia númerica del 1 al 10,0000 llamado t:
t=1:100000
...
# Primero creamos los objetos que serán insumos para los cálculos de VF:
VA=1
i=1
nTotal=10000
t=1:nTotal
