...
En el siguiente fragmento, se aproxima el número $e$ con 1 a 100,000 períodos de recomposición ($n$) en 1 año de un préstamo de un peso al 100\% anualizado.
...
i=1
# Períodos de recomposición deseados:
nTotal=1000
t=1:nTotal
# Tabla de salida:
